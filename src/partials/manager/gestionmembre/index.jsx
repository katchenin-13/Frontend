...
function ListeMembre() {
    const { membres, showMembre, deleteMembre } = useMembre(useMembreActions);
    const [searchText, setSearchText] = useState("");
    const [currentPage, setCurrentPage] = useState(1);
    const rowsPerPage = 3;
    console.log(membres,);

    const gotToEditPage = (membre) => {
        if (membre && Object.keys(membre).length > 0) {
            localStorage.setItem("membre", JSON.stringify(membre)); // ✅ Stocke correctement l'objet sélectionné
            console.log("Membre sélectionné :", membre);
        } else {
    ...
    const filteredData = membres.filter(
        (item) =>
                    ...
                    <section className="container px-4 mx-auto">
                        ...
                        <div className="sm:flex sm:items-center sm:justify-between">
                            ...
                            <div className="flex items-center mt-4 gap-x-3">
                                ...
                                >
                                    <Link to="/manager-dashboard/AddMembre" className="flex items-center w-full">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                                        ...
                                                        <td className="texte-wrap px-4 py-4 text-sm whitespace-nowrap">
                                                            <div className="flex items-center space-x-2">
                                                                ...
                                                                <button
                                                                    ...
                                                                    title="Edit"
                                                                    onClick={() => gotToEditPage(item)}

                                                                >
                                                                    <Link to="/manager-dashboard/EditMembre" className="flex items-center w-full">
                                                                        <svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            fill="none"
                                                                            viewBox="0 0 24 24"
                                                                ...
                                                                <button
                                                                    ...
                                                                    title="View"
                                                                    onClick={() => showMembre(item)} // Passer l'objet entier ici
                                                                >
                                                                    <svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        fill="none"
