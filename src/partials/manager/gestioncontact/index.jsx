...
function ListeContact() {
    const { contacts, showContact, deleteContact } = useContact(useContactActions);
    ...
    const gotToEditPage = (contact) => {
        if (contact && Object.keys(contact).length > 0) {
            localStorage.setItem("contact", JSON.stringify(contact)); // ✅ Stocke correctement l'objet sélectionné
    ...
    return (
        <div className="col-span-full xl:col-span-12 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            ...
            <header className="px-5 py-4 border-b border-gray-200 dark:border-gray-700/60">
                <h2 className="font-semibold text-gray-800 dark:text-gray-100">Liste des contacts</h2>
            </header>
                    ...
                    <section className="container px-4 mx-auto">
                        ...
                        <div className="sm:flex sm:items-center sm:justify-between">
                            ...
                            <div className="flex items-center mt-4 gap-x-3">
                                ...
                                >
                                    <Link to="/manager-dashboard/AddContact" className="flex items-center w-full">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td className="texte-wrap px-4 py-4 text-sm whitespace-nowrap">
                                                            <div className="flex items-center space-x-2">
                                                                ...
                                                                >
                                                                    <Link to="/manager-dashboard/EditContact" className="flex items-center w-full">
                                                                        <svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            fill="none"
                                                                            viewBox="0 0 24 24"
                                                                ...
                                                                <button
                                                                    ...
                                                                    title="View"
                                                                    onClick={() => showContact(item)} // Passer l'objet entier ici
                                                                >
                                                                    <svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        fill="none"
