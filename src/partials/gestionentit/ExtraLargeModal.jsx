...
const ExtraLargeModal = () => {
    ...
    return (
        <>
            <button onClick={toggleModal} className="btn-open-modal">Open Modal</button>

            {isOpen && (
                <div
                    id="extralarge-modal"
                    tabIndex="-1"
                    className="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto h-[calc(100%-1rem)] max-h-full"
                >
