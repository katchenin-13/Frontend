              ...
              <SidebarLinkGroup activecondition={pathname.includes("gestiontypes")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="/admin-dashboard/typeentite"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${pathname.includes("gestiontypes") ? "" : "hover:text-gray-900 dark:hover:text-white"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin-dashboard/typeactivite"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " + (isActive ? "text-violet-500" : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                              }
                            >
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin-dashboard/typebeneficiaire"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " + (isActive ? "text-violet-500" : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                              }
                            >
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin-dashboard/GestionEntite"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " + (isActive ? "text-violet-500" : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                              }
                            >
