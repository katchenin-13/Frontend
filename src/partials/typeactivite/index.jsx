...
function ListeEntity() {
    ...
    const options = [
        { value: "option1", label: "Produits" },
        { value: "option2", label: "Services" },
        { value: "option3", label: "Clients" },
    ];
    ...
    const data1 = {
        ...
        option2: [
            { nom: "Développement Web", tarif: "50€/heure" },
            { nom: "Design Graphique", tarif: "40€/heure" },
        ],
        option3: [
            { nom: "Jean Dupont", ville: "Paris" },
            { nom: "Sophie Martin", ville: "Lyon" },
        ],
    };
    const openModal = () => {
        setIsModalOpen(true);
                    ...
                    <section className="container px-4 mx-auto">
                        ...
                        <div className="sm:flex sm:items-center sm:justify-between">
                            ...
                            <div className="flex items-center mt-4 gap-x-3">
                                ...
                                >
                                    <Link to="/pages/AddActivite" className="flex items-center w-full">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
