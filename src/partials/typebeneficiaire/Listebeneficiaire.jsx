...
const data = [
  ...
  { libelle: 'ONG', nombreentite: 12, datecreation: '12/15/2025' },
  { libelle: 'Coopérative', nombreentite: 5, datecreation: '01/01/2026' },
  { libelle: 'Partenaire', nombreentite: 9, datecreation: '01/15/2026' },
];
    ...
    return (
      <div className="col-span-full xl:col-span-12 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
        ...
        <header className="px-5 py-4 border-b border-gray-200 dark:border-gray-700/60">
          <h2 className="font-semibold text-gray-800 dark:text-gray-100">Liste des beneficiaires</h2>
        </header>
