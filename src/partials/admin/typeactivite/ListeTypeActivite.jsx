...
const data = [
  { libelle: 'Audience', nombreActivite: 10, datecreation: '10/20/2025' },
  { libelle: 'Dons', nombreActivite: 20, datecreation: '10/20/2025' },
  { libelle: 'Promesses', nombreActivite: 15, datecreation: '11/01/2025' },
  { libelle: 'Gouvernement', nombreActivite: 25, datecreation: '11/10/2025' },
  { libelle: 'Association', nombreActivite: 8, datecreation: '12/01/2025' },
  { libelle: 'ONG', nombreActivite: 12, datecreation: '12/15/2025' },
  { libelle: 'Coopérative', nombreActivite: 5, datecreation: '01/01/2026' },
  { libelle: 'Partenaire', nombreActivite: 9, datecreation: '01/15/2026' },
];

function ListeTypeActivite() {
...
// Index de l'élément à éditer
  ...
  const handleAddEntite = (e) => {
    ...
    const newEntite = {
      libelle,
      nombreActivite: dynamicFields.length,
        ...
        <div className="overflow-x-auto">
          <div className="relative flex flex-col w-full h-full text-gray-700 bg-white shadow-md rounded-xl">
            ...
            <div className="p-4 flex justify-between">
              <h5 className="text-lg font-semibold text-gray-800">Liste des activités</h5>
              ...
              <table className="w-full text-left table-auto text-sm text-gray-700">
                <thead className="bg-sky-600 text-white">
                  <tr>
                    ...
                    <th className="p-4">Nombre d'activités</th>
                ...
                <tbody>
                  {currentRows.map((item, index) => (
                    <tr key={index} className="hover:bg-gray-100">
                      ...
                      <td className="p-4">{item.nombreActivite}</td>
...
export default ListeTypeActivite;
